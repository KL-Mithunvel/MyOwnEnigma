...
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { o_lb0 }]; #ck_io26IO_L24P_T3_A01_D17_14        Sch=jd10/ck_io[26]
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { o_lb1 }]; #ck_io27IO_L23N_T3_A02_D18_14        Sch=jd9/ck_io[27]
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { o_lb2 }]; #ck_io28IO_L23P_T3_A03_D19_14        Sch=jd8/ck_io[28]
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { o_lb3 }]; #ck_io29IO_L22N_T3_A04_D20_14        Sch=jd7/ck_io[29]
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33 } [get_ports { o_lb4 }]; #IO_L22P_T3_A05_D21_14        Sch=jd4/ck_io[30]
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { o_lb4N }]; #IO_L21N_T3_DQS_A06_D22_14    Sch=jd3/ck_io[31]
